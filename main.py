...
from MolNexTR.model import Encoder, Decoder
...
from MolNexTR.tokenizer import get_tokenizer
...
def get_args():
    ...
    group.add_argument("--dec_num_layers", help="No. of layers in Decoder decoder", type=int, default=6)
